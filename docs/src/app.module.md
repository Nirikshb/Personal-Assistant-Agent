...
4. `imports` array — Config, Ollama, Gmail, Web, Agent, maybe Observe.
...
Nest requires one root module. The assistant should orchestrate. Feature modules (Ollama, Gmail, Web, Agent) get **imported** here.
